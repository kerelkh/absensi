...
@section('content')
    ...
    <nav class="flex mb-5 pb-2 border-b border-gray-400" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{ URL::current() }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Form Admin Dinas</a>
            </div>
        </li>
    </nav>
