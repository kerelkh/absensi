...
@section('content')
    ...
    <div class="max-w-xl">
        <form method="POST" onsubmit="confirmCreate(event)" enctype="multipart/form-data">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <label for="pangkat" class="sr-only">Underline select</label>
                <select id="pangkat" name="pangkat" id="pangkat" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
