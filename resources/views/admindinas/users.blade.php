                ...
                <tbody>
                    @forelse($users as $user)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                {{ $user->useronopd->valid == 0 ? 'Belum Validasi' : 'Tervalidasi' }}
                            </td>
                            <td class="px-6 py-4 text-right">
                                <a href="/admin/dinas/{{ $user->email }}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            </td>
                        </tr>
                    @empty
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
